function ServicesCard() {
  const data = [
    ...
    {
      id: 4,
      image: "https://github.com/abelmorad/merdeka-info-tek/blob/main/public/products/pwa.svg",
    ...
    {
      id: 5,
      image: "https://github.com/abelmorad/merdeka-info-tek/blob/main/public/products/website.svg",
