function ServicesCard() {
  const data = [
    ...
    {
      id: 2,
      image: "/public/products/mobile.svg",
    ...
    {
      id: 5,
      image: "/public/products/website.svg",
  ...
  return (
    <>
      {data.map((data) => (
        <div className="flex flex-col items-center text-center border border-gray-300 rounded-md p-4 gap-5 tablet:flex-row">
